#' Create a Blank Quarto File - R Notes
#'
...
#'
#' @param template_name The name of the Quarto skeleton file = "r_notes". You
...
#'
#' # Set a new file name
#' new_quarto_r_notes("test_qmd_file")
#'
#' # Set new file location other than here::here()
#' # No forward slash at the end
#' new_quarto_r_notes(file_loc = "/Users/bradcannell/Desktop")
new_quarto_r_notes <- function(
    file_name     = NULL,
    file_loc      = here::here(),
    template_name = "r_notes") {
